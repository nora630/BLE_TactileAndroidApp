package com.onodera.BleApp.cgm;
...
public class CGMService extends BleProfileService implements CGMManagerCallbacks {
    private static final String ACTION_DISCONNECT = "com.onodera.BleApp.cgms.ACTION_DISCONNECT";
    ...
    public static final String BROADCAST_NEW_CGMS_VALUE = "com.onodera.BleApp.cgms.BROADCAST_NEW_CGMS_VALUE";
    public static final String BROADCAST_DATA_SET_CLEAR = "com.onodera.BleApp.cgms.BROADCAST_DATA_SET_CLEAR";
    public static final String OPERATION_STARTED = "com.onodera.BleApp.cgms.OPERATION_STARTED";
    public static final String OPERATION_COMPLETED = "com.onodera.BleApp.cgms.OPERATION_COMPLETED";
    public static final String OPERATION_SUPPORTED = "com.onodera.BleApp.cgms.OPERATION_SUPPORTED";
    public static final String OPERATION_NOT_SUPPORTED = "com.onodera.BleApp.cgms.OPERATION_NOT_SUPPORTED";
    public static final String OPERATION_FAILED = "com.onodera.BleApp.cgms.OPERATION_FAILED";
    public static final String OPERATION_ABORTED = "com.onodera.BleApp.cgms.OPERATION_ABORTED";
    public static final String EXTRA_CGMS_RECORD = "com.onodera.BleApp.cgms.EXTRA_CGMS_RECORD";
    public static final String EXTRA_DATA = "com.onodera.BleApp.cgms.EXTRA_DATA";
